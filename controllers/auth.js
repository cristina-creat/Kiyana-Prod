            ...
            console.log(user);
                ...
                if (err || !user || !user.password) {
                    ...
                    if ( !bcrypt.compareSync( user.secret_key+'-'+params.password, user.password) ) {
                        next({ status: 200, message: 'Email o contraseña incorrectos.', error: 'Email o contraseña incorrectos.' });
                    } else {
    ...
    if (userData && userData._id) {
        ...
        tmp_access.save((err, access_stored) => {
            ...
            if (!err && access_stored) {
                ...
                */
                var options = {
                    subject: 'Solicitud de reestablecimiento de contraseña para ' + config.options.p,
                    recipients: {},
